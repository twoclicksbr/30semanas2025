<section id="" class="">
    <div class="wrapper image-wrapper bg-cover bg-image bg-overlay bg-overlay-500"
        data-image-src="/assets/img/banner-2025.jpg"
        style="background-image: url(&quot;/assets/img/banner-2025.jpg&quot;);">
            ...
            <div class="row">
                <div class="col-md-9 col-lg-8 col-xl-7 col-xxl-6 " data-cues="zoomIn" data-group="page-title"
                    ...
                    <h1 class="display-2 fs-50 text-white mb-7" data-cue="zoomIn" data-interval="-200"
                        ...
                        <mark style="background-color: #8b5a3c80;">1° de maio - Quinta-Feira.</mark>
                    </h1>

                    <a href="/cadastro" class="btn btn-orange btn-icon btn-icon-start rounded share-btn w-100" data-cue="zoomIn" data-interval="-200" data-group="page-title" data-delay="200" data-show="true" style="animation-name: zoomIn; animation-duration: 700ms; animation-timing-function: ease; animation-delay: 1200ms; animation-direction: normal; animation-fill-mode: both;">
                        <span class="desktop-text fs-25">Faça sua Inscrição</span>
                    </a>
