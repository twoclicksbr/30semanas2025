...
@section('content')
                ...
                <div class="col-lg-7 col-xl-6 col-xxl-12 mx-auto mt-n20">
                    <div class="card">
                        <div class="card-body p-11">
                            <h2 class="mb-3 text-start">Grupos</h2>
    ...
    <script>
        const API_URL = `{{ config('api.base_url') }}/api/v1/group`;
        ...
        async function loadData() {
            try {
                ...
                if (groups.total === 0) {
                    ...
                    document.getElementById('record-info').innerText =
                        `${groups.to - groups.from + 1} registros exibidos, de um total de ${groups.total}`;
                }

                renderPagination(groups.links);
        ...
        async function exportToCSV() {
            try {
                ...
                const data = res.data.groups.data;
